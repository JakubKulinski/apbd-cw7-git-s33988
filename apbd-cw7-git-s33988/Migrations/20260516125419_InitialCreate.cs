        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "NVIDIA", new DateOnly(1993, 4, 5), "NVIDIA Corporation" },
                    { 3, "SAMSUNG", new DateOnly(1969, 1, 13), "Samsung Electronics Co., Ltd." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "990PRO2TB ", 3, 4, "Gen4 NVMe SSD, 7450 MB/s read", "Samsung 990 Pro 2 TB NVMe" },
                    { "DDR5-32GB ", 3, 3, "High-speed DDR5 memory module", "Samsung 32 GB DDR5-5600" },
                    { "I5-13500  ", 1, 1, "Mid-range desktop processor, 14 cores", "Intel Core i5-13500" },
                    { "I9-14900K ", 1, 1, "High-end desktop processor, 24 cores, 6.0 GHz boost", "Intel Core i9-14900K" },
                    { "RTX4090   ", 2, 2, "Flagship Ada Lovelace GPU, 24 GB GDDR6X", "NVIDIA GeForce RTX 4090" }
                });
